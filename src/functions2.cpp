...
void SetCam(Camera *cam,const Mode k_fmt7Mode=MODE_1, const PixelFormat k_fmt7PixFmt=PIXEL_FORMAT_RAW8){
    ...
    Format7PacketInfo* fmt7PacketInfo = new Format7PacketInfo;
...
int Rec_SingleCamera(void* tdata)
{
    ...
    SetCam(RSC_input->cam);

    // Start capturing images
    RSC_input->cam->StartCapture();
